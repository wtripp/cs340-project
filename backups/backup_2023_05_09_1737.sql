...
CREATE TABLE `ActorRoles` (
  ...
  UNIQUE KEY `actor_role_id_UNIQUE` (`actor_role_id`),
  KEY `actor_id_idx` (`actor_id`),
  KEY `movie_id_idx` (`movie_id`),
  CONSTRAINT `fk_actor_roles_actor_id` FOREIGN KEY (`actor_id`) REFERENCES `Actors` (`actor_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_actor_roles_movie_id` FOREIGN KEY (`movie_id`) REFERENCES `Movies` (`movie_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `Actors` VALUES (1,'Christian','Bale'),(2,'Al','Pacino'),(3,'Uma','Thurman'),(4,'Tom','Hanks'),(5,'Meryl','Streep'),(6,'Jeff','Bridges'),(7,'Julianne','Moore');
...
CREATE TABLE `Memorabilia` (
  ...
  CONSTRAINT `fk_memorabilia_order_id` FOREIGN KEY (`order_id`) REFERENCES `Orders` (`order_id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `MovieItems` (
  ...
  UNIQUE KEY `movie_item_id_UNIQUE` (`movie_item_id`),
  KEY `item_id_idx` (`item_id`),
  KEY `movie_id_idx` (`movie_id`),
  CONSTRAINT `fk_movie_items_item_id` FOREIGN KEY (`item_id`) REFERENCES `Memorabilia` (`item_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_movie_items_movie_id` FOREIGN KEY (`movie_id`) REFERENCES `Movies` (`movie_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `Orders` (
  ...
  CONSTRAINT `fk_orders_customer_id` FOREIGN KEY (`customer_id`) REFERENCES `Customers` (`customer_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
-- Dump completed on 2023-05-09 14:37:41
